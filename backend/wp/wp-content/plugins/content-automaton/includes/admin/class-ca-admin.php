...
class CA_Admin {
    ...
    private function render_drafts() {
        ...
        echo '<p>These articles were successfully generated by AI and are awaiting your review.</p>';
    ...
    private function render_settings() {
        ...
        echo '<tr><th><label style="font-weight:bold;">Custom Cron Schedule</label></th><td>';
        echo 'Run every <input type="number" name="ca_cron_num" value="' . esc_attr($cron_num) . '" min="1" style="width:80px;"> ';
        echo '<select name="ca_cron_unit">';
        echo '<option value="minutes" ' . selected($cron_unit, 'minutes', false) . '>Minutes</option>';
        echo '<option value="hours" ' . selected($cron_unit, 'hours', false) . '>Hours</option>';
        echo '<option value="days" ' . selected($cron_unit, 'days', false) . '>Days</option>';
        echo '</select><p class="description">How often the engine automatically checks your sources.</p></td></tr>';
        ...
        echo '<input type="password" name="ca_openai_key" value="' . esc_attr(get_option('ca_openai_key')) . '" style="width:100%;">';
        echo '<p class="description"><a href="https://platform.openai.com/api-keys" target="_blank">Get OpenAI API Key</a></p></td></tr>';
        
        echo '<tr><th><label style="font-weight:bold;">Google Gemini API Key</label></th><td>';
        echo '<input type="password" name="ca_gemini_key" value="' . esc_attr(get_option('ca_gemini_key')) . '" style="width:100%;">';
        echo '<p class="description"><a href="https://aistudio.google.com/app/apikey" target="_blank">Get Google Gemini API Key</a></p></td></tr>';
        
        echo '<tr><td colspan="2"><hr></td></tr>';
        
        echo '<tr><th><label style="font-weight:bold;">Unsplash API Key</label></th><td>';
        echo '<input type="password" name="ca_unsplash_key" value="' . esc_attr(get_option('ca_unsplash_key')) . '" style="width:100%;">';
        echo '<p class="description"><a href="https://unsplash.com/developers" target="_blank">Get Unsplash API Key</a></p></td></tr>';
        
        echo '<tr><th><label style="font-weight:bold;">Pexels API Key</label></th><td>';
        echo '<input type="password" name="ca_pexels_key" value="' . esc_attr(get_option('ca_pexels_key')) . '" style="width:100%;">';
        echo '<p class="description"><a href="https://www.pexels.com/api/" target="_blank">Get Pexels API Key</a></p></td></tr>';
        
        echo '<tr><th><label style="font-weight:bold;">Pixabay API Key</label></th><td>';
        echo '<input type="password" name="ca_pixabay_key" value="' . esc_attr(get_option('ca_pixabay_key')) . '" style="width:100%;">';
        echo '<p class="description"><a href="https://pixabay.com/api/docs/" target="_blank">Get Pixabay API Key</a></p></td></tr>';
